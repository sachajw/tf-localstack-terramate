...
globals {
  ...
  terraform_aws_provider_version = "~> 4.0"
  terraform_aws_provider_region  = "us-east-1"

  # this should be adjusted when testing actual deployemnts
  terraform_aws_provider_project = "mineiros-terramate-${global.environment}"
  ...
  location = global.terraform_aws_provider_region
}
